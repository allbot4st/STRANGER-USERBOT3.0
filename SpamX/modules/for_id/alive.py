...
async def SpamX_(SpamX: Client, message: Message):
    ...
    spamx_reply += f"**pyStranger Version:** `{rizoelx_vr}` \n"
    ...
    spamx_reply += "<=======================> \n\n"
    spamx_reply += "**Source Code:** [GitHub 🐈‍⬛](https://github.com/oyethomassir/id-USERBOT) \n\n"
    spamx_reply += "**© @i_m_fighter** || Support: @ll4st_MIND_GAMERII"
